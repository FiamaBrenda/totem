...
const Index = () => {
  ...
  const announceScreen = () => {
    const screenTitles: Record<string, string> = {
      welcome: 'Bem-vindo ao Totem de Autoatendimento. Por favor, selecione como deseja ser atendido. Você pode escolher entre 8 opções de atendimento personalizado.',
      service: 'Selecione o serviço desejado. Você pode escolher entre RG, Registro Geral, ou CPF, Cadastro de Pessoa Física.',
      documents: 'Documentos necessários para o atendimento. Você precisará de certidão de nascimento ou casamento, comprovante de residência atualizado, e documento anterior se tiver.',
      data: 'Preencha seus dados pessoais. Informe seu nome completo, CPF e telefone.',
      photo: 'Captura de foto. Olhe para a câmera e aguarde.',
      payment: 'Escolha a forma de pagamento. Você pode pagar com PIX, Cartão ou Boleto.',
      protocol: 'Atendimento concluído com sucesso. Seu protocolo foi gerado e enviado para seu WhatsApp.',
    };

    const announcement = screenTitles[currentScreen] || '';
    
    // Atualiza o aria-live para leitores de tela nativos
    const ariaLive = document.getElementById('aria-live-announcer');
    if (ariaLive) {
      ariaLive.textContent = announcement;
    }
    
    // Usa a API de síntese de voz para ler em voz alta
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {personas.map((persona, index) => (
                <div
                  ...
                  onMouseEnter={() => {
                    if (accessibilitySettings.screenReader) {
                      speakText(t(`personas.${persona.id}.description`));
                    }
                  }}
                  onFocus={() => {
                    if (accessibilitySettings.screenReader) {
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
              <Card
                ...
                onMouseEnter={() => {
                  if (accessibilitySettings.screenReader) {
                    speakText('RG. Segunda via do Registro Geral');
                  }
                }}
                onFocus={() => {
                  if (accessibilitySettings.screenReader) {
              ...
              <Card
                ...
                onMouseEnter={() => {
                  if (accessibilitySettings.screenReader) {
                    speakText('CPF. Segunda via do Cadastro de Pessoa Física');
                  }
                }}
                onFocus={() => {
                  if (accessibilitySettings.screenReader) {
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {[
                  ...
                  <Card
                    ...
                    onMouseEnter={() => {
                      if (accessibilitySettings.screenReader) {
                        speakText(`Pagar com ${method.label}`);
                      }
                    }}
                    onFocus={() => {
                      if (accessibilitySettings.screenReader) {
